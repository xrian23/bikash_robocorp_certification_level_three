...
Validate traffic data
    ...
    Log    ${traffic_data}
    ${json_country_key}=    Set Variable    country
    ${country}=    Set Recursion Limit For System    ${traffic_data}    ${json_country_key}
...
Post traffic data to sales System
    ...
    ...    json=${traffic_data}
    Handel Traffic API Response    ${status}    ${return}    ${traffic_data}

Handel Traffic API Response
